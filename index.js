...
import { Shield, TrendingUp, Globe, ArrowRight, Activity, Cpu, Lock, X, Menu, ChevronDown, Coins } from 'lucide-react';
...
// --- 2. Interactive Fluid Grid Background (Three.js) - Dynamic Import ---
const FluidGridBackground = () => {
  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      // Grid System
      geometry = new THREE.PlaneGeometry(150, 150, 60, 60);
...
export default function UnifiedLabsRedesign() {
  return (
    <>
      <Head>
        <title>Unified Labs | Institutional DeFi Infrastructure</title>
      </Head>
      ...
      <div className="bg-black min-h-screen text-white selection:bg-white selection:text-black overflow-x-hidden">
        ...
        {/* --- HERO SECTION --- */}
        <section className="relative h-screen flex flex-col justify-center px-6 z-10">
